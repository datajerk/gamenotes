...
def dump_lanette_pc():
	...
	for box in range(14):
		...
		for index in range(30):
			...
			mons.append([box,index+1,sid,item])
...
def lanette_pc_box():
	...
	for mon in mons:
		...
		sid = mon[2]
		item = mon[3]
		format_string = '{0:02d}. {1:03d} {2:' + str(maxmonlen) + 's} {3:' + str(maxitemlen) + 's}'
		item_name = items_index[item]
		if item_name == 'NONE': item_name = ''
		print(format_string.format(index+1,sid,sid_index[sid],item_name))
...
def lanette_pc_name():
	...
	for mon in mons:
		...
		item_name = items_index[item]
		if item_name == 'NONE': item_name = ''
		format_string = '{0:02d} {1} {2:02d}. {3:03d} {4:' + str(maxmonlen) + 's} {5:' + str(maxitemlen) + 's}'
		lines.append(format_string.format(box+1,c,index+1,sid,sid_index[sid],item_name))

	lines.sort(key = lambda x: x[13:])
